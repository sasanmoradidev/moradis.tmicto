...
var site = $('Body');
/*site.css('overflow','hidden') فعلا نباشد*/
$(".scroll-container .scroll").click(function() {
  $("html, body").animate({scrollTop: $("#khadamat").offset().top}, 1000);
  site.css('overflow-x','hidden')
  site.css('overflow-y','visible')

});
   $(".list-icons a").click(function() {
        id=$(this).attr("href")
        $('html, body').animate({
